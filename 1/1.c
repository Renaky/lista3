...
int main(){
    ...
    do{
      ...
      switch(op){
      	...
      	break;
      	case 3: printf("Nome da banda a ser buscado:");
      			fflush(stdin); gets(nomeBusca);
      			buscaBanda(bandas, nomeBusca);
      	break;		
      	case 4: printf("Ranking para buscar:");
      			scanf("%d",&rank);
      			buscaRanking(bandas, rank);
      			
      	break;
      	case 6: printf("Nome da banda a ser removido:");
      			fflush(stdin); gets(nomeBusca);
      			removeBanda(bandas, nomeBusca);
      	break;	
		case 7: printf("Nome da banda a ser alterado:");
      			fflush(stdin); gets(nomeBusca);
      			alteraBanda(bandas, nomeBusca);
      	break;
		case 8: printf("Genero da banda a ser buscado:");
      			fflush(stdin); gets(nomeBusca);
      			buscaGenero(bandas, nomeBusca);
      	break;
		case 9: printf("Nome da banda a ser buscado(com favorito):");
      			fflush(stdin); gets(nomeBusca);
